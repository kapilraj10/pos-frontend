...
const App = () => {
  ...
  const isAdminPage = ['/dashboard', '/manage-items', '/manage-category', '/manage-users'].includes(location.pathname);
  ...
  return (
    <div>
      ...
      <div className={!isAuthPage ? (isAdminPage ? 'admin-layout' : 'main-content') : ''}>
        {!isAuthPage && (
          <ToastContainer
            position="top-center"
            autoClose={2500}
